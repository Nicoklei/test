...
df = pd.read_excel(path_d, sheet_name=24,skiprows=4, usecols=[8])
...
plt.plot([65,469],[0.6,0.6],color='black', label='Nominal value')
plt.plot([65,469],[0.65,0.65],color='black', label='Error margin',linestyle='dashed')
plt.plot([65,469],[0.55,0.55],color='black',linestyle='dashed')
