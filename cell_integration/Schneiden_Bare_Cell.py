...
class MainWindow(QMainWindow):
	...
	def __init__(self):
		...
		global path
		global path_folder
		path_folder = '/home/loaded_cell_qc/sciebo - Klein, Nico (s6nnklei@uni-bonn.de)@uni-bonn.sciebo.de/CERN_Doku/P1/P1_BareCellFoto/'
		global up_down
		up_down = 0
		...
		if up_down == 2:
			...
			for horizontal in range(4):
				...
				for vertical in range(5):
					...
					Cell1.save("Bare_Cell_pictures/1.%i.png"%(serial_number+vertical+horizontal*4+counter))
			...
			for horizontal in range(4):
				...
				for vertical in range(5):
					...
					Cell1.save("Bare_Cell_pictures/1.%i.png"%(serial_number+vertical+horizontal*4+counter))
     				#print(round(serial_number+vertical/10000+horizontal/10000*4+counter/10000,4))
				counter += 1
		path = 'BareCell_1-0%i-0%i'%(serial_number+20, serial_number+39)
