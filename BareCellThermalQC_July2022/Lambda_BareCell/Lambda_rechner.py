...
datafile7 = np.loadtxt('0-0060/Messung3/Gemittelte_Werte_0-0060.txt', delimiter='\t', unpack=True)
...
datafile100 = np.loadtxt('Bare_Cell_Dicke_gemessen', delimiter='\t', unpack=True)
A100,A101 = datafile100[0],datafile100[1]
...
D=[C12[0],C12[1],C12[2],C[0],C[1],C[2],C[3],C1[0],C1[1],C1[2],C1[3],C2[0],C2[1],C2[2],C3[0],C3[1],C3[2],C11[0],C11[1],C11[2],C5[0],C5[1],C5[2],C5[3],C4[0],C4[1],C4[2],C6[0],C6[1],C6[2],C7[0],C7[1],C7[2]]#,C8[0],C8[1],C8[2],C8[3],C8[4],C9[2]]
dD=[dC12[0],dC12[1],dC12[2],dC[0],dC[1],dC[2],dC[3],dC1[0],dC1[1],dC1[2],dC1[3],dC2[0],dC2[1],dC2[2],dC3[0],dC3[1],dC3[2],dC11[0],dC11[1],dC11[2],dC5[0],dC5[1],dC5[2],dC5[3],dC4[0],dC4[1],dC4[2],dC6[0],dC6[1],dC6[2],dC7[0],dC7[1],dC7[2]]#,dC8[0],dC8[1],dC8[2],dC8[3],dC8[4],dC9[2]]

D1=[C13[0],C13[1],C13[2],C14[0],C14[1],C14[2],C14[3],C15[0],C15[1],C15[2],C16[0],C16[1],C16[2],C16[3],C16[4],C17[0],C17[1],C17[2],C18[0],C18[1],C18[2],C19[0],C19[1],C19[2],C20[0],C20[1],C20[2],C21[0],C21[1],C21[2],C21[3],C21[4],C21[5],C22[0],C22[1],C22[2]]
dD1=[dC13[0],dC13[1],dC13[2],dC14[0],dC14[1],dC14[2],dC14[3],dC15[0],dC15[1],dC15[2],dC16[0],dC16[1],dC16[2],dC16[3],dC16[4],dC17[0],dC17[1],dC17[2],dC18[0],dC18[1],dC18[2],dC19[0],dC19[1],dC19[2],dC20[0],dC20[1],dC20[2],dC21[0],dC21[1],dC21[2],dC21[3],dC21[4],dC21[5],dC22[0],dC22[1],dC22[2]]
...
D1=[np.sum(C13/dC13**2)/np.sum(1/dC13**2),np.sum(C14/dC14**2)/np.sum(1/dC14**2),np.sum(C15/dC15**2)/np.sum(1/dC15**2),np.sum(C16/dC16**2)/np.sum(1/dC16**2),np.sum(C17/dC17**2)/np.sum(1/dC17**2),np.sum(C18/dC18**2)/np.sum(1/dC18**2),np.sum(C19/dC19**2)/np.sum(1/dC19**2),np.sum(C20/dC20**2)/np.sum(1/dC20**2),np.sum(C21/dC21**2)/np.sum(1/dC21**2),np.sum(C22/dC22**2)/np.sum(1/dC22**2)]
dD1=[np.sqrt(1/np.sum(1/dC13**2)),np.sqrt(1/np.sum(1/dC14**2)),np.sqrt(1/np.sum(1/dC15**2)),np.sqrt(1/np.sum(1/dC16**2)),np.sqrt(1/np.sum(1/dC17**2)),np.sqrt(1/np.sum(1/dC18**2)),np.sqrt(1/np.sum(1/dC19**2)),np.sqrt(1/np.sum(1/dC20**2)),np.sqrt(1/np.sum(1/dC21**2)),np.sqrt(1/np.sum(1/dC22**2))]


E=[A100[0]-A101[0],A100[0]-A101[0],A100[0]-A101[0],A100[1]-A101[1],A100[1]-A101[1],A100[1]-A101[1],A100[1]-A101[1],A100[2]-A101[2],A100[2]-A101[2],A100[2]-A101[2],A100[2]-A101[2],A100[3]-A101[3],A100[3]-A101[3],A100[3]-A101[3],A100[4]-A101[4],A100[4]-A101[4],A100[4]-A101[4],A100[5]-A101[5],A100[5]-A101[5],A100[5]-A101[5],A100[6]-A101[6],A100[6]-A101[6],A100[6]-A101[6],A100[6]-A101[6],A100[7]-A101[7],A100[7]-A101[7],A100[7]-A101[7],A100[8]-A101[8],A100[8]-A101[8],A100[8]-A101[8],A100[9]-A101[9],A100[9]-A101[9],A100[9]-A101[9]]
E1=[A100[4]-A101[4],A100[4]-A101[4],A100[4]-A101[4],A100[9]-A101[9],A100[9]-A101[9],A100[9]-A101[9],A100[9]-A101[9],A100[8]-A101[8],A100[8]-A101[8],A100[8]-A101[8],A100[7]-A101[7],A100[7]-A101[7],A100[7]-A101[7],A100[7]-A101[7],A100[7]-A101[7],A100[6]-A101[6],A100[6]-A101[6],A100[6]-A101[6],A100[5]-A101[5],A100[5]-A101[5],A100[5]-A101[5],A100[3]-A101[3],A100[3]-A101[3],A100[3]-A101[3],A100[2]-A101[2],A100[2]-A101[2],A100[2]-A101[2],A100[1]-A101[1],A100[1]-A101[1],A100[1]-A101[1],A100[1]-A101[1],A100[1]-A101[1],A100[1]-A101[1],A100[0]-A101[0],A100[0]-A101[0],A100[0]-A101[0]]
E=[A100[0]-A101[0],A100[1]-A101[1],A100[2]-A101[2],A100[3]-A101[3],A100[4]-A101[4],A100[5]-A101[5],A100[6]-A101[6],A100[7]-A101[7],A100[8]-A101[8],A100[9]-A101[9]]
E1=[A100[4]-A101[4],A100[9]-A101[9],A100[8]-A101[8],A100[7]-A101[7],A100[6]-A101[6],A100[5]-A101[5],A100[3]-A101[3],A100[2]-A101[2],A100[1]-A101[1],A100[0]-A101[0]]
E=[A100[0],A100[1],A100[2],A100[3],A100[4],A100[5],A100[6],A100[7],A100[8],A100[9]]
E1=[A100[4],A100[9],A100[8],A100[7],A100[6],A100[5],A100[3],A100[2],A100[1],A100[0]]
#curve-fit-program
...
plt.errorbar(E,D,yerr=dD, color='royalblue',fmt='.',label='Datenpunkt aus erster Messung')#'m = %s +/- %s \nn = %s +/- %s \nd = %s +/- %s'%(str(popt[0].round(5)),str(errors[0].round(5)),str(popt[1].round(5)),str(errors[1].round(5)),str(popt[2].round(5)),str(errors[2].round(5))))
plt.errorbar(E1,D1,yerr=dD1, color='crimson',fmt='.',label='Datenpunkt aus zweiter Messung')#'m = %s +/- %s \nn = %s +/- %s \nd = %s +/- %s'%(str(popt[0].round(5)),str(errors[0].round(5)),str(popt[1].round(5)),str(errors[1].round(5)),str(popt[2].round(5)),str(errors[2].round(5))))
...
plt.xlabel('Dicke des Klebers / mm')
...
plt.savefig("TFM_aller_Cells_gegen_Dicke_mittel_plus_Cooling")
