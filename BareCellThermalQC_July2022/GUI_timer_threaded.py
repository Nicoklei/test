...
class MainWindow(QMainWindow):
	...
	def update_spirale_peltier(self):
		...
		self.widgetl00L8.setText("Jetziger Strom\n" + str(cur))
		time.sleep(0.05)
		d.set_channel(2)
		time.sleep(0.05)
		vol = d.get_voltage()
		...
		self.widget11G.setLabel('bottom', 'Datenpunkte / 5s', color='b')
	...
	def set_text(self,A):
		...
		###Fehler von lambda###
		#print(str(round(np.sqrt(((float(cur)*float(vol))/((((100*(A[0][0]/(A[5][0]-A[0][0])))-99.954)/0.39087)-(((100*(A[1][0]/(A[5][0]-A[1][0])))-99.954)/0.39087))**2*0.05/(0.0001*np.pi))**2*(((np.sqrt((((100*(A[0][0]/(A[5][0]-A[0][0])))-99.954)/0.39087**2)**2*0.00049**2+(1/0.39087)**2*0.1364**2+(1/0.39087*(330/(A[0][0]-A[5][0])**2))**2*A[0][1]**2+(1/0.39087*(100*(A[0][0]/(A[5][0]-A[0][0])**2)))**2*A[5][1]**2)+((A[0][0]/(A[5][0]-A[0][0]))/0.39087)**2*0.00324)**2)+(np.sqrt((((100*(A[1][0]/(A[5][0]-A[1][0])))-99.954)/0.39087**2)**2*0.00049**2+(1/0.39087)**2*0.1364**2+(1/0.39087*(330/(A[1][0]-A[5][0])**2))**2*A[1][1]**2+(1/0.39087*(100*(A[1][0]/(A[5][0]-A[1][0])**2)))**2*A[5][1]**2)+((A[0][0]/(A[5][0]-A[0][0]))/0.39087)**2*0.00324)**2)),2)))
		#print(str(round(np.sqrt(((float(cur)*float(vol))/((((100*(A[1][0]/(A[5][0]-A[1][0])))-99.954)/0.39087)-(((100*(A[2][0]/(A[5][0]-A[2][0])))-99.954)/0.39087))**2*0.0076/(0.0001*np.pi))**2*((np.sqrt((((100*(A[1][0]/(A[5][0]-A[1][0])))-99.954)/0.39087**2)**2*0.00049**2+(1/0.39087)**2*0.1364**2+(1/0.39087*(330/(A[1][0]-A[5][0])**2))**2*A[1][1]**2+(1/0.39087*(100*(A[1][0]/(A[5][0]-A[1][0])**2)))**2*A[5][1]**2)+((A[0][0]/(A[5][0]-A[0][0]))/0.39087)**2*0.00324)**2+(np.sqrt((((100*(A[2][0]/(A[5][0]-A[2][0])))-99.954)/0.39087**2)**2*0.00049**2+(1/0.39087)**2*0.1364**2+(1/0.39087*(330/(A[2][0]-A[5][0])**2))**2*A[2][1]**2+(1/0.39087*(100*(A[2][0]/(A[5][0]-A[2][0])**2)))**2*A[5][1]**2)+((A[0][0]/(A[5][0]-A[0][0]))/0.39087)**2*0.00324)**2)),2)))
		#print(str(round(np.sqrt(((float(cur)*float(vol))/((((100*(A[2][0]/(A[5][0]-A[2][0])))-99.954)/0.39087)-(((100*(A[3][0]/(A[5][0]-A[3][0])))-99.954)/0.39087))**2*0.05/(0.0001*np.pi))**2*((np.sqrt((((100*(A[2][0]/(A[5][0]-A[2][0])))-99.954)/0.39087**2)**2*0.00049**2+(1/0.39087)**2*0.1364**2+(1/0.39087*(330/(A[2][0]-A[5][0])**2))**2*A[2][1]**2+(1/0.39087*(100*(A[2][0]/(A[5][0]-A[2][0])**2)))**2*A[5][1]**2)+((A[0][0]/(A[5][0]-A[0][0]))/0.39087)**2*0.00324)**2+(np.sqrt((((100*(A[3][0]/(A[5][0]-A[3][0])))-99.954)/0.39087**2)**2*0.00049**2+(1/0.39087)**2*0.1364**2+(1/0.39087*(330/(A[3][0]-A[5][0])**2))**2*A[3][1]**2+(1/0.39087*(100*(A[3][0]/(A[5][0]-A[3][0])**2)))**2*A[5][1]**2)+((A[0][0]/(A[5][0]-A[0][0]))/0.39087)**2*0.00324)**2)),2)))
		#print(str(round(1/(np.sqrt(100*((3.9083*10**(-3))**2*100+4*(-5.775*10**(-7))*((100*(A[0][0]/(A[5][0]-A[0][0])))-100))))*np.sqrt((A[0][0]/(A[5][0]-A[0][0]))**2*0.00324**2+((100*(A[0][0]/(A[5][0]-A[0][0])**2))**2*(A[5][1])**2)+((100*(A[5][0]/(A[0][0]-A[5][0])**2)))**2*(A[0][1])**2),4)))
		#print(str(round(1/(np.sqrt(100*((3.9083*10**(-3))**2*100+4*-5.775*10**(-7)*((100*(A[1][0]/(A[5][0]-A[1][0])))-100))))*np.sqrt((A[1][0]/(A[5][0]-A[1][0]))**2*0.00324**2+((100*(A[1][0]/(A[5][0]-A[1][0])**2))**2*(A[5][1])**2)+((100*(A[5][0]/(A[1][0]-A[5][0])**2)))**2*(A[1][1])**2),4)))
		#print(str(round(1/(np.sqrt(100*((3.9083*10**(-3))**2*100+4*-5.775*10**(-7)*((100*(A[2][0]/(A[5][0]-A[2][0])))-100))))*np.sqrt((A[2][0]/(A[5][0]-A[2][0]))**2*0.00324**2+((100*(A[2][0]/(A[5][0]-A[2][0])**2))**2*(A[5][1])**2)+((100*(A[5][0]/(A[2][0]-A[5][0])**2)))**2*(A[2][1])**2),4)))
		#print(str(round(1/(np.sqrt(100*((3.9083*10**(-3))**2*100+4*-5.775*10**(-7)*((100*(A[3][0]/(A[5][0]-A[3][0])))-100))))*np.sqrt((A[3][0]/(A[5][0]-A[3][0]))**2*0.00324**2+((100*(A[3][0]/(A[5][0]-A[3][0])**2))**2*(A[5][1])**2)+((100*(A[5][0]/(A[3][0]-A[5][0])**2)))**2*(A[3][1])**2),4)))
