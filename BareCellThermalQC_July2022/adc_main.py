...
def main(mode=None, data=None, *args, **kwargs):
    """
...
def client(data, *args, **kwargs):
    ...
    adc_utils.send(tcp_socket=sock, HEADERSIZE=10, data=gain)
    # logging.debug(data)
    ...
    while True:
        ...
        while time.time() < timeout:
            ...
            if query:
                ...
                data = adc_utils.send(tcp_socket=sock, HEADERSIZE=10, data="Query data taking")
                
                logging.debug("Received data")
                logging.debug(data)
                #return data
                ads.gain, bds.gain, cds.gain = data[0], data[1], data[2]
...
if __name__ == "__main__":
    main(None, None, sys.argv)    #print(main("-c"))
