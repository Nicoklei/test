...
path_d = 'Gewicht_Kali_weniger_Volt/Gewicht_Kalibration_Zelle_2.txt'
datafile = np.loadtxt(path_d, delimiter='\t', unpack=True)
a,b = 14,15
A1,B1 = datafile[a],datafile[b]

A=np.array([43,37.5,32,26.5,23.75,21,18,15.5,13,9.25,4.75])+0.62
...
plt.tight_layout()
plt.savefig("Kalibration_Zelle2_4V_mVV.png")
