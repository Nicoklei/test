...
datafile = np.loadtxt('90_Grad1/Gemittelte_Werte_0-0053_mit_Soft-PGS_90_Grad_gedreht1.txt', delimiter='\t', unpack=True)
A,dA,B,dB = datafile[2],datafile[3],datafile[4],datafile[5]
datafile1 = np.loadtxt('90_Grad2/Gemittelte_Werte_0-0053_mit_Soft-PGS_90_Grad_gedreht2.txt', delimiter='\t', unpack=True)
A1,dA1,B1,dB1 = datafile1[2],datafile1[3],datafile1[4],datafile1[5]
datafile2 = np.loadtxt('90_Grad3/Gemittelte_Werte_0-0053_mit_Soft-PGS_90_Grad_gedreht3.txt', delimiter='\t', unpack=True)
A2,dA2,B2,dB2 = datafile2[2],datafile2[3],datafile2[4],datafile2[5]
datafile3 = np.loadtxt('180_Grad1/Gemittelte_Werte_0-0053_mit_Soft-PGS_180_Grad_gedreht1.txt', delimiter='\t', unpack=True)
A3,dA3,B3,dB3 = datafile3[2],datafile3[3],datafile3[4],datafile3[5]
datafile4 = np.loadtxt('180_Grad2/Gemittelte_Werte_0-0053_mit_Soft-PGS_180_Grad_gedreht2.txt', delimiter='\t', unpack=True)
A4,dA4,B4,dB4 = datafile4[2],datafile4[3],datafile4[4],datafile4[5]
datafile5 = np.loadtxt('180_Grad3/Gemittelte_Werte_0-0053_mit_Soft-PGS_180_Grad_gedreht3.txt', delimiter='\t', unpack=True)
A5,dA5,B5,dB5 = datafile5[2],datafile5[3],datafile5[4],datafile5[5]
datafile6 = np.loadtxt('270_Grad1/Gemittelte_Werte_0-0053_mit_Soft-PGS_270_Grad_gedreht1.txt', delimiter='\t', unpack=True)
A6,dA6,B6,dB6 = datafile6[2],datafile6[3],datafile6[4],datafile6[5]
datafile7 = np.loadtxt('270_Grad2/Gemittelte_Werte_0-0053_mit_Soft-PGS_270_Grad_gedreht2.txt', delimiter='\t', unpack=True)
A7,dA7,B7,dB7 = datafile7[2],datafile7[3],datafile7[4],datafile7[5]
datafile8 = np.loadtxt('270_Grad4/Gemittelte_Werte_0-0053_mit_Soft-PGS_270_Grad_gedreht4.txt', delimiter='\t', unpack=True)
A8,dA8,B8,dB8 = datafile8[2],datafile8[3],datafile8[4],datafile8[5]
datafile9 = np.loadtxt('zum_Raum1/Gemittelte_Werte_0-0053_mit_Soft-PGS_zum_Raum1.txt', delimiter='\t', unpack=True)
A9,dA9,B9,dB9 = datafile9[2],datafile9[3],datafile9[4],datafile9[5]
datafile10 = np.loadtxt('zum_Raum2/Gemittelte_Werte_0-0053_mit_Soft-PGS_zum_Raum2.txt', delimiter='\t', unpack=True)
A10,dA10,B10,dB10 = datafile10[2],datafile10[3],datafile10[4],datafile10[5]
datafile11 = np.loadtxt('zum_Raum3/Gemittelte_Werte_0-0053_mit_Soft-PGS_zum_Raum2.txt', delimiter='\t', unpack=True)
...
# dD= np.append(dD,dC9)
# D1 = np.append(D1,C10)
# dD1= np.append(dD1,dC10)
# D2 = np.append(D2,C11)
# dD2= np.append(dD2,dC11)
# D = np.append(D,C)
# dD= np.append(dD,dC)
# D1 = np.append(D1,C1)
# dD1= np.append(dD1,dC1)
# D2 = np.append(D2,C2)
# dD2= np.append(dD2,dC2)
# D = np.append(D,C3)
# dD= np.append(dD,dC3)
# D1 = np.append(D1,C4)
# dD1= np.append(dD1,dC4)
# D2 = np.append(D2,C5)
# dD2= np.append(dD2,dC5)
# D = np.append(D,C6)
# dD= np.append(dD,dC6)
# D1 = np.append(D1,C7)
# dD1= np.append(dD1,dC7)
# D2 = np.append(D2,C8)
# dD2= np.append(dD2,dC8)
...
plt.errorbar(E2,D2,yerr=dD2, color='navy',fmt='.',label='Datenpunkt aus dritter Messung')#'m = %s +/- %s \nn = %s +/- %s \nd = %s +/- %s'%(str(popt[0].round(5)),str(errors[0].round(5)),str(popt[1].round(5)),str(errors[1].round(5)),str(popt[2].round(5)),str(errors[2].round(5))))
...
plt.xlabel('Drehung der Cell 0-0053')
...
plt.tight_layout()
plt.savefig("TFM_0-0053_gedreht_mit_Soft_PGS")
